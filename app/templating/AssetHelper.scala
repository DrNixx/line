...
trait AssetHelper { self: I18nHelper with SecurityHelper =>
  ...
  def basicCsp(implicit req: RequestHeader): ContentSecurityPolicy = {
    ...
    ContentSecurityPolicy(
      ...
      connectSrc = "'self'" :: assets :: sockets ::: env.explorerEndpoint :: env.tablebaseEndpoint :: "https://www.chess-online.com" :: "https://www.google-analytics.com" :: "https://stats.g.doubleclick.net" :: "https://mc.yandex.ru" :: Nil,
      ...
      imgSrc = List("data:", "*"),
      scriptSrc = List("'self'", "'unsafe-eval'", assets, "https://passport.chess-online.com", "https://www.googletagmanager.com", "https://www.google-analytics.com", "https://stats.g.doubleclick.net", "https://mc.yandex.ru"),
      baseUri = List("'none'")
    )
  }
