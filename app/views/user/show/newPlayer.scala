...
object newPlayer {
  ...
  def apply(u: User) =
    div(cls := "new-player")(
      h2("Welcome to Chess-Online.Com!"),
      p(
      ...
      ul(
        ...
        li(a(href := routes.User.list())("Follow your friends on Chess-Online")),
        ...
        li(a(href := routes.Pref.form("game-display"))("Configure Chess-Online to your liking")),
