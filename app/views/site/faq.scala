  ...
  def apply()(implicit ctx: Context) = help.layout(
    ...
    moreCss = cssTag("faq")
      ...
      main(cls := "faq small-page box box-pad")(
        ...
        h2("Chess-Online Arena"),
        question(
          "contributing",
          "How can I contribute to Chess-Online Arena?",
          p("Chess-Online Arena is powered by donations from patrons and the efforts of a team of volunteers."),
          p("You can find out more about ", a(href := routes.Plan.index())("being a patron"), " (including a ", a(href := routes.Main.costs())("breakdown of our costs"), "). If you want to help Chess-Online Arena by volunteering your time and skills, there are many ", a(href := routes.Page.help())("other ways to help"), ".")
        ),
        question(
          "sites_based_on_Lichess",
          "Are there websites based on Chess-Online Arena?",
          p(
            "Yes. Chess-Online Arena has indeed inspired other open-source sites that use our ",
            a(href := "/source")("source code"), ", ",
            a(href := "/api")("API"), ", or ",
            a(href := "https://database.chess-online.com")("database"), "."
          ),
          ul(
            li(a(href := "https://lichess.org")("Lichess")),
        ...
        question(
          ...
          p("Chess-Online Arena has strong detection methods and a very thorough process for reviewing all the evidence and making a decision. The process often involves many moderators and can take a long time. Other than the mark itself, we will not go into details about evidence or the decision making process for individual cases. Doing so would make it easier to avoid detection in the future, and be an invitation to unproductive debates. That time and effort is better spent on other important cases. Users can appeal by emailing contact@chess-online.com, but decisions are rarely overturned.")
        ),
        question(
          "rating-refund",
        ...
        question(
          ...
          p("On Chess-Online Arena, the main difference in rules for correspondence chess is that an opening book is allowed. The use of engines is still prohibited and will result in being flagged for engine assistance. Although ICCF allows engine use in correspondence, Lichess does not.")
        ),
        h2("Gameplay"),
        question(
          "variants",
          "What variants can I play on Chess-Online Arena?",
          p("Chess-Online Arena supports standard chess and ", a(href := routes.Page.variantHome())("8 chess variants"), ".")
        ),
        question(
          "acpl",
          ...
          p("The computer analysis on Chess-Online Arena is powered by Stockfish.")
        ),
        question(
          "timeout",
        ...
        question(
          ...
          p("See the ", a(href := s"${routes.Learn.index()}#/15")("Chess-Online Arena training"), " on this move for some practice with it.")
        ),
        h2("Accounts"),
        question(
          "titles",
          "What titles are there on Chess-Online Arena?",
          p(
            "Chess-Online Arena recognises all FIDE titles gained from OTB (over the board) play, as well as ",
          ...
          p("Verifying as a titled player on Chess-Online gives access to play in the Titled Arena events."),
          p("Finally there is an honorary ", a(href := "#lm")("Chess-Online Master (COM)"), " title.")
        ),
        question(
          "lm",
          "How do I get the Chess-Online Arena Master (COM) title?",
          p("This honorific title is unofficial and only exists on Chess-Online Arena."),
          p("We award it to highly notable players who are good citizens of Chess-Online Arena, at our discretion. You don't get the COM title, the COM title gets to you. If you qualify, you will get a message from us regarding it and the choice to accept or decline.")
        ),
        question(
          "usernames",
        ...
        question(
          ...
          p("That trophy is unique in the history of Chess-Online Arena, nobody other than ", a(href := "https://live.chess-online.com/@/hiimgosu")("hiimgosu"), " will ever have it."),
          p("To get it, hiimgosu challenged himself to berserk and win 100% games of ", a(href := "https://live.chess-online.com/tournament/cDyjj1nL")("a hourly bullet tournament"), "."),
          h4("The Golden Zee"),
          p("That trophy is unique in the history of Chess-Online Arena, nobody other than ", a(href := "https://live.chess-online.com/@/ZugAddict")("ZugAddict"), " will ever have it."),
        ...
        h2("Chess-Online Arena ratings"),
        question(
          "ratings",
          "What rating system does Chess-Online Arena use?",
        ...
        question(
          ...
          p("Chess-Online can optionally send popup notifications, for example when it is your turn or you received a private message."),
          p("Click the lock icon next to the Chess-Online.Com address in the URL bar of your browser."),
          p("Then select whether to allow or block notifications from Chess-Online.")
        )
      )
    }
}
