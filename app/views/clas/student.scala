...
object student {
      ...
      div(cls := "box__pad")(
        ...
        s.student.archived map { archived =>
          div(cls := "student-show__archived archived")(
            ...
            postForm(action := routes.Clas.studentArchive(clas.id.value, s.user.id, v = false))(
        ...
        s.student.managed option div(cls := "student-show__managed")(
          ...
          div(cls := "student-show__managed__actions")(
            postForm(action := routes.Clas.studentSetKid(clas.id.value, s.user.id, !s.user.kid))(
            ...
            postForm(action := routes.Clas.studentResetPassword(clas.id.value, s.user.id))(
            ...
            a(
              href := routes.Clas.studentRelease(clas.id.value, s.user.id),
    ...
    div(cls := "student-show__top")(
      ...
      div(cls := "student-show__top__meta")(
        ...
        div(
          ...
          a(
            href := routes.Clas.studentEdit(clas.id.value, s.user.id),
            cls := "button button-empty"
          )(trans.edit()),
          a(
  ...
  def edit(clas: Clas, students: List[Student], s: Student.WithUser, form: Form[_])(implicit ctx: Context) =
    bits.layout(s.user.username, Left(clas withStudents students), s.student.some)(
      ...
      div(cls := "box__pad")(
        standardFlash(),
        postForm(cls := "form3", action := routes.Clas.studentUpdate(clas.id.value, s.user.id))(
          form3.globalError(form),
          realNameField(form),
          ...
          form3.actions(
            a(href := routes.Clas.studentShow(clas.id.value, s.user.id))(trans.cancel()),
        ...
        s.student.isActive option frag(
          hr,
          postForm(
            action := routes.Clas.studentArchive(clas.id.value, s.user.id, v = true),
  ...
  def release(clas: Clas, students: List[Student], s: Student.WithUser, form: Form[_])(implicit
    ...
    bits.layout(s.user.username, Left(clas withStudents students), s.student.some)(
      ...
      div(cls := "box__pad")(
        ...
        postForm(cls := "form3", action := routes.Clas.studentReleasePost(clas.id.value, s.user.id))(
          form3.globalError(form),
          form3.group(
            form("email"),
            trans.email(),
