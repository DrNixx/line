...
set JAVA_OPTS=-Xms2048M -Xmx2048M -Xss1M -XX:MaxMetaspaceSize=1024M -XX:ReservedCodeCacheSize=64m -XX:+ExitOnOutOfMemoryError -Dreactivemongo.api.bson.document.strict=false
