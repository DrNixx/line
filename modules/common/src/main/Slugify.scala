...
/** This makes pretty slugs out of any string in any charset.
  ...
  *
  * Most reasonable seems to use Transliterator from ICU4J library with custom mappings. This is very likely
  * quite slow: needs benchmarking.
  *
  * Credits: http://stackoverflow.com/questions/10188575/convert-latin-characters-to-normal-text-in-java
  * http://stackoverflow.com/questions/1657193/java-code-library-for-generating-slugs-for-use-in-pretty-urls
  */
object Slugify:
  val ASCII = """Russian-Latin/BGN; Any-Latin; Latin-ASCII; [^\p{Print}] Remove; ['"] Remove; Any-Lower"""
