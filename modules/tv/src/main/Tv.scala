  ...
  object Channel {
    case object Best
        extends Channel(
          ...
          filters = Seq(rated(1700), standard, noBot) // filters = Seq(rated(2150), standard, noBot)
        )
    case object Bullet
        extends Channel(
          name = S.Bullet.name,
          ...
          filters = Seq(speed(S.Bullet), rated(1300), standard, noBot) // filters = Seq(speed(S.Bullet), rated(2000), standard, noBot)
        )
    case object Blitz
        extends Channel(
          name = S.Blitz.name,
          ...
          secondsSinceLastMove = freshBlitz,
          filters = Seq(speed(S.Blitz), rated(1300), standard, noBot) // filters = Seq(speed(S.Blitz), rated(2000), standard, noBot)
        )
    case object Rapid
        extends Channel(
          name = S.Rapid.name,
          ...
          filters = Seq(speed(S.Rapid), rated(1100), standard, noBot) // filters = Seq(speed(S.Rapid), rated(1800), standard, noBot)
        )
    case object Classical
        extends Channel(
          ...
          filters = Seq(speed(S.Classical), rated(1050), standard, noBot) // filters = Seq(speed(S.Classical), rated(1650), standard, noBot)
        )
    ...
    case object UltraBullet
        extends Channel(
          ...
          filters = Seq(speed(S.UltraBullet), rated(1000), standard, noBot) // filters = Seq(speed(S.UltraBullet), rated(1600), standard, noBot)
        )
    case object Bot
        extends Channel(
          name = "Bot",
